####
##code from https://github.com/rayidghani/magicloops
####
...
def clf_loop(models_to_run, clfs, grid, X, y):
    results_df =  pd.DataFrame(columns=('model_type','clf', 'parameters', 'auc-roc','p_at_5', 'p_at_10', 'p_at_20', 'time'))
    for n in range(1, 2):
        ...
        for index,clf in enumerate([clfs[x] for x in models_to_run]):
            ...
            for p in ParameterGrid(parameter_values):
                try:
                    ...
                    times = time.perf_counter() - begin_time
                    ...
                    results_df.loc[len(results_df)] = [models_to_run[index],clf, p,
                                                       ...
                                                       precision_at_k(y_test_sorted,y_pred_probs_sorted,20.0), times]
                    if NOTEBOOK == 1:
